...
* WP.org-konform: keine Lizenzprüfung, kein Cron, keine externen Calls außer Provider-API

**PRO-Addon (kommerziell, separates Plugin):**

* Unlimitierte Objekte
* Mehrere Provider parallel
* Automatischer Import (WP-Cron, Webhooks)
...
Nein – in der FREE-Version nur manueller Import. WP-Cron und Webhooks sind PRO-Features.
